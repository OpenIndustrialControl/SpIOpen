/*
SpIOpen Message Frame Message : Stub implementation.
...
etl::expected<void, FrameMessageError> FrameMessage::AllocateToPublisher(
    MessageType message_type, const publisher::FramePublisherHandle_t* publisher_handle, uint8_t initial_references) {
...
MessageType FrameMessage::GetMessageType() const { return message_type_; }
