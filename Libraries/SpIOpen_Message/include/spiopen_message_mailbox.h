/*
SpIOpen Message Frame Mailbox : Thread-safe message queue wrapper used by broker and subscribers.
...
#ifdef CONFIG_SPIOPEN_MESSAGE_MAILBOX_MAX_DEPTH
static constexpr size_t MESSAGE_MAILBOX_MAX_DEPTH = CONFIG_SPIOPEN_MESSAGE_MAILBOX_MAX_DEPTH;
#else
...
class FrameMailbox : public ILifecycleComponent<FrameMailboxConfig, LifecycleError> {
   public:
     ...
     *
     * @return Success on unconfigure, or LifecycleErrorType::InvalidState
     */
     ...
     *
     * @return Drained message count, or FrameMailboxError::InvalidState /
     ...
     * @return Success, or FrameMailboxError::InvalidArgument / FrameMailboxError::InvalidState /
     * FrameMailboxError::PreconditionFailed / FrameMailboxError::QueueTimeout /
     * FrameMailboxError::QueueFailure / FrameMailboxError::ResourceFailure
     */
     ...
     * @note ISR-safe when timeout_ticks is 0.
     * @return Message pointer, or FrameMailboxError::InvalidState / FrameMailboxError::QueueTimeout /
     * FrameMailboxError::QueueFailure / FrameMailboxError::ResourceFailure
     */
