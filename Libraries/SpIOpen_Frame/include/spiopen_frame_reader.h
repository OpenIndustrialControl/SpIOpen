 ...
 * negative for missing bits never received)
 * @return FrameReadResult structure containing the error code and DLC correction flag
 */
static FrameReadResult ReadAndCopyFrame(const uint8_t *buffer, size_t buffer_length, Frame *out_frame,
                                        uint8_t *out_buffer, size_t out_buffer_length, size_t buffer_offset = 0,
 ...
 */
static FrameSearchResult FindFrame(const uint8_t *buffer, size_t length, size_t buffer_offset = 0,
