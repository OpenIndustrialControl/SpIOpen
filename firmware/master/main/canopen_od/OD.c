/*******************************************************************************
 CANopen Object Dictionary – SpIOpen master (ESP32-C3).
 Based on slave OD; compatible with CANopenNode V4 master + gateway ASCII.
*******************************************************************************/
...
static CO_PROGMEM ODObjs_t ODObjs = {
 ...
 .o_6200_RGB = {
 {
 .dataOrig = &OD_RAM.x6200_RGB.highestSub_indexSupported,
 .subIndex = 0,
 .attribute = ODA_SDO_R,
 .dataLength = 1
 },
 {
 .dataOrig = &OD_RAM.x6200_RGB.red,
 .subIndex = 1,
 .attribute = ODA_SDO_RW | ODA_TPDO,
 .dataLength = 1
 },
 {
 .dataOrig = &OD_RAM.x6200_RGB.green,
 .subIndex = 2,
 .attribute = ODA_SDO_RW | ODA_TPDO,
 .dataLength = 1
 },
 {
 .dataOrig = &OD_RAM.x6200_RGB.blue,
 .subIndex = 3,
 .attribute = ODA_SDO_RW | ODA_TPDO,
 .dataLength = 1
 }
...
static OD_ATTR_OD OD_entry_t ODList[] = {
 ...
 {0x6200, 0x04, ODT_REC, &ODObjs.o_6200_RGB, NULL},
