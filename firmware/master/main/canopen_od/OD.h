/*******************************************************************************
 ...
 Minimal DS301 OD for CANopenNode master + gateway ASCII; same structure as slave.
*******************************************************************************/
...
typedef struct {
 ...
 /* 0x6200 RGB LED (R, G, B) – mapped to RxPDO1 */
 struct {
 uint8_t highestSub_indexSupported;
 uint8_t red;
 uint8_t green;
...
#define OD_ENTRY_H6200 &OD->list[33]
...
#define OD_ENTRY_H6200_RGB &OD->list[33]
