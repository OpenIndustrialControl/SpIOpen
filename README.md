...
SpIOpen devices use a router that connects all of the frame produceers and Subscribers within a node.
...
It is designed to run on a real-time system and requires proper porting for real-time scheduling, symaphores, and queues.
...
The router is implemented in Libraries\SpIOpen_Router. 
